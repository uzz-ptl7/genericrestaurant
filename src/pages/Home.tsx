          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">Quick preparation and delivery to your doorstep</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">Convenient pickup locations across the city</p>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              ...
              <div className="flex items-center justify-center space-x-3">
                ...
                <span className="text-lg">123 Restaurant St, Food City</span>
              </div>
            </div>
          </div>
        </div>
